...
def makeDelaunay(srcframe, destframe, srcfaces, destfaces, srclandmarks, destlandmarks, elapsedtime):
    print("do it")
    ...
    opacity = AddDelaunay.translate(elapsed_time, 0, 5, 0, 255)
        ...
        if twofaces == True:
            ...
            if matchresult == True:
                ...
                if elapsed_time < 5:
                    ...
                    results = makeDelaunay(video_process.frame, video_process.frame2, video_process.faces, video_process.faces2, video_process.landmarks, video_process.landmarks2, elapsed_time)
