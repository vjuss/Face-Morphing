...
#making opencv find landmarks in the blended frame (also try separately before they are blended), basic detcttion is from https://www.youtube.com/watch?v=MrRGVOhARYY
#draw these landmarks
