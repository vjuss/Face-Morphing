...
def main():
    ...
    while True:
        ...
        if matchresult == True: 
            ...
            elif len(pastframes1) > 30 and len(pastframes1) <= 60: #EFFECT 2. later: timer less than 40s 
                print("effect 2")
            ...
            #
            #
            elif len(pastframes1) > 60 and len(pastframes1) <= 90: #EFFECT 3. later: timer less than 60s 
                print("effect 3")
                resultframe = cv2.cvtColor(vidframe, cv2.COLOR_BGR2GRAY) 
                resultframe2 = cv2.cvtColor(vidframe2, cv2.COLOR_BGR2GRAY) 
